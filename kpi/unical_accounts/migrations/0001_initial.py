        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, max_length=254,
                 null=True, verbose_name='email address')),
                ('matricola', models.CharField(blank=True, help_text='come rappresentata su CSA',
                 max_length=6, null=True, verbose_name='Matricola')),
                ('first_name', models.CharField(blank=True,
                 max_length=30, null=True, verbose_name='Nome')),
                ('last_name', models.CharField(blank=True,
                 max_length=30, null=True, verbose_name='Cognome')),
                ('codice_fiscale', models.CharField(blank=True,
                 max_length=16, null=True, verbose_name='Codice Fiscale')),
                ('gender', models.CharField(blank=True, choices=[('male', 'Maschio'), ('female', 'Femmina'), (
                    'other', 'Altro')], max_length=12, null=True, verbose_name='Genere')),
                ('location', django_countries.fields.CountryField(blank=True,
                 max_length=2, null=True, verbose_name='Luogo di nascita')),
