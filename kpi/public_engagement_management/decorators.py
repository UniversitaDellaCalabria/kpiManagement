...
from . settings import PUBLIC_ENGAGEMENT_OFFICE_SLUG


def can_view_structure_public_engagements(func_to_decorate):
    """
    """
...
def can_manage_structure_public_engagements(func_to_decorate):
    """
    """
    def new_func(*original_args, **original_kwargs):
        request = original_args[0]
